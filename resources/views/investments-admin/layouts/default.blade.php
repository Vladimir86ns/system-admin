...
<header class="header">
    <a href="{{ route('investments-admin-dashboard') }}" class="logo">
    ...
    <nav class="navbar navbar-static-top" role="navigation">
        ...
        <div class="navbar-right">
            <ul class="nav navbar-nav">
                @include('investments-admin.layouts._messages')
                @include('investments-admin.layouts._notifications')
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-footer">
                            ...
                            <div class="pull-right">
                                <a href="{{ URL::to('investments-admin/logout') }}">
    ...
    <aside class="left-side sidebar-offcanvas">
        <section class="sidebar ">
            <div class="page-sidebar  sidebar-nav">
                ...
                <!-- BEGIN SIDEBAR MENU -->
                @include('investments-admin.layouts._left_menu')
                <!-- END SIDEBAR MENU -->
            </div>
        </section>
    </aside>
