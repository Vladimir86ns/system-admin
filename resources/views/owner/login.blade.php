                ...
                <div id="container_demo">
                    ...
                    <div id="wrapper">
                        <div id="login" class="animate form">
                            <form action="{{ route('owner-signin') }}" autocomplete="on" method="post" role="form" id="login_form">
                                <h3 class="black_bg">
                        ...
                        <div id="register" class="animate form">
                            <form action="{{ route('owner-signup') }}" autocomplete="on" method="post" role="form" id="register_here">
                                <h3 class="black_bg">
                                    <!-- Add picture logo here when create it -->
                                    <!-- <img src="{{ asset('assets/img/logo.png') }}" alt="josh logo"> -->
